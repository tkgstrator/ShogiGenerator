...
$(document).ready(function () {
    ...
    // JSONを作成する
    // URLの値をとってこれるかどうか
    path = "/kif/" + $(".shogiboard").val() + ".sfen";
    console.log(path);
    $.get("https://shogi.mydns.jp/kif/ryu3005.sfen", function (data) {
...
function viewControl() {
    ...
    $('ul').append('<li class="material-icons btn" onclick="first()">first_page</li>');
    $('ul').append('<li class="material-icons btn" onclick="prev()">chevron_left</li>');
    $('ul').append('<li class="material-icons btn" onclick="next()">chevron_right</li>');
    $('ul').append('<li class="material-icons btn" onclick="last()">last_page</li>');
